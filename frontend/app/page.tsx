      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-24 grid grid-cols-3 gap-6">
          <div className="rounded-2xl border border-zinc-800 p-6">
            ...
            <p className="text-zinc-400">Destinations</p>
          </div>

          <div className="rounded-2xl border border-zinc-800 p-6">
            <h2 className="text-3xl font-bold text-orange-400">AI</h2>
            <p className="text-zinc-400">Personalized Planning</p>
          </div>

          <div className="rounded-2xl border border-zinc-800 p-6">
            <h2 className="text-3xl font-bold text-orange-400">24/7</h2>
            <p className="text-zinc-400">Smart Assistance</p>
          </div>
        </div>
      </section>
    </main>
